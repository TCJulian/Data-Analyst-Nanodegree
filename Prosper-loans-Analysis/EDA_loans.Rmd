...
Investigating each of the above variables, escpecially those that might be correlated with farvorable conditions, might lead to more insight into understanding the underlying data.
...
ggplot(subset(loans, !is.na(loans$ratings) & loans$ratings != "NC"), aes(x = ratings, y = BorrowerRate)) + 
  geom_boxplot()
```
