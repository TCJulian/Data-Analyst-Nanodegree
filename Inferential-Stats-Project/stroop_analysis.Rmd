...
All the pieces are in place. It is time to calculate the t-statistic:
...
Because the t-score is well below the t-critical value, we reject the null hypothesis. The congruent and incongruent trials are significantly different at the 0.05 confidence level, with a p-value < .001.
